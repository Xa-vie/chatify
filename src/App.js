...
if (!firebase.apps.length) {
  firebase.initializeApp({
    apiKey: "AIzaSyC2rB9wryoV1Ny60V0rqCzu43sXgza2gEI",
    authDomain: "app-management-6c4e0.firebaseapp.com",
    databaseURL: "https://app-management-6c4e0.firebaseio.com",
    projectId: "app-management-6c4e0",
    storageBucket: "app-management-6c4e0.appspot.com",
    messagingSenderId: "434541956584",
    appId: "1:434541956584:web:3e04efcd146b4bfaff285d"
  });
} else {
      ...
      <div className="flex items-center justify-center shadow-md h-full">
        <div className="flex flex-col items-center justify-center max-w-xl w-full mx-4 p-8 rounded-md shadow-card bg-white dark:bg-coolDark-600 transition-all">
          ...
          <p className="mb-8 text-lg text-center">
            Want to have a small talk? <p>Try Chatify, its the easiest way to chat with people all around the world.</p>
          </p>
          <button
